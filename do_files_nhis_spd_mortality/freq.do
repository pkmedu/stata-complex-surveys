...
label define x_age_grp_v ///
			1 "35-44 Yrs" ///
			2 "45-54 Yrs" ///
			3 "55-64 Yrs" ///
			4="65-74"	
label values x_age_grp x_age_grp_v
...
label value heavydrk heavydrk_lab
 ...
 tab mortstat
 table cig_dis sex xspd2, by(cigsmoke_r mortstat) content(freq) row col sc 
 table cig_dis sex xspd2, by(cigsmoke_r2 mortstat) content(freq) row col sc
 table cig_dis sex xmdd, by(cigsmoke_r2 mortstat) content(freq) row col sc
 
 table cig_dis2 sex xspd2 , by(cigsmoke_r mortstat) content(freq ) row col sc
 table cig_dis2 sex xspd2, by(cigsmoke_r2 mortstat) content(freq) row col sc
 table cig_dis2 sex xmdd, by(cigsmoke_r2 mortstat) content(freq) row col sc
 
 table cig_dis3 sex xspd2 , by(cigsmoke_r mortstat) content(freq ) row col sc
 table cig_dis3 sex xspd2, by(cigsmoke_r2 mortstat) content(freq) row col sc
 table cig_dis3 sex xmdd, by(cigsmoke_r2 mortstat) content(freq) row col sc
