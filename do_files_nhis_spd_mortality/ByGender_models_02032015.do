 ...
 ***********************************************
 ...
 local demo i.dur_cat age_p  i.racehisp i.marital
...
fvset base 2 xspd2 chronic1p racehisp 
...
foreach depvar of varlist  dead lp_death m_cvd_death {
   		capture noisily svy,subpop(if model_obs==1 & sex==1): cloglog `depvar' `demo' `ses ' ///
	...
	foreach depvar of varlist  dead lp_death m_cvd_death {
		...
		foreach depvar of varlist  dead lp_death m_cvd_death {
   		capture noisily svy,subpop(if model_obs==1 & sex==2): cloglog `depvar' `demo' `ses ' ///
		i.xspd2 i.cigsmoke_3c i.xspd2##i.cigsmoke_3c ///		
		i.alc_s i.phy_s i.chronic1p , eform nolog
	}	
