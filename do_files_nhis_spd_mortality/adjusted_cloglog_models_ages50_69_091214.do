...
log using "E:\Stata_mortality\age50_69.log", name (age50_69) replace
...
capture noisily svy,subpop(age_50_69): cloglog dead `demo' i.xspd2, eform nolog
est store m1

capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses' i.xspd2 i.chronic1p, eform nolog
est store m2

capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses' i.xspd2 i.chronic1p i.xcigsmoke  i.xalcstat , eform nolog
est store m3

capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses' i.xspd2 i.chronic1p i.xcigsmoke  i.xalcstat i.bmicat, eform nolog
est store m4

estout m1 m2  m3 m4 using "E:\Stata_mortality\m1_2_3_4_ages50_69.txt", replace ///
...
capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses'  i.chronic1p, eform nolog
est store m5

capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses'  i.xcigsmoke, eform nolog
est store m6

capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses' i.xalcstat , eform nolog
est store m7

capture noisily svy,subpop(age_50_69): cloglog dead `demo' `ses' i.bmicat, eform nolog
est store m8

estout m5 m6  m7 m8 using "E:\Stata_mortality\m5_6_7_8_ages50_69.txt", replace ///
cells("b(fmt(%5.2f) star) ci(par([  ,  ]) fmt(%6.2f))" ) eform ///
stats(N_sub, fmt(%12.0gc) labels("PY of obs")) ///
collabels("RR" "95% CI") drop(_cons) style(fixed)


capture noisily svy,subpop(age_50_69): cloglog dead  i.xspd2, eform nolog
est store m9

capture noisily svy,subpop(age_50_69): cloglog dead  i.chronic1p, eform nolog
est store m10

capture noisily svy,subpop(age_50_69): cloglog dead  i.xcigsmoke, eform nolog
est store m11

capture noisily svy,subpop(age_50_69): cloglog dead  i.xalcstat , eform nolog
est store m12

capture noisily svy,subpop(age_50_69): cloglog dead  i.bmicat, eform nolog
est store m13

estout m9 m10 m11 m12 m13 using "E:\Stata_mortality\m9_thru_13_ages50_69.txt", replace ///
cells("b(fmt(%5.2f) star) ci(par([  ,  ]) fmt(%6.2f))" ) eform ///
stats(N_sub, fmt(%12.0gc) labels("PY of obs")) ///
collabels("RR" "95% CI") drop(_cons) style(fixed)
