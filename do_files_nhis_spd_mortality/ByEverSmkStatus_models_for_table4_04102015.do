...
capture log close EverSMK_Models_ages50_74
clear
set more off
...
*/
*log using "H:\spd_mort_results\EverSMK_Models_ages50_74.log", name (EverSMK_Models_ages50_74) replace
...
foreach smk_strata of varlist EverSMKNew   {

foreach depvar of varlist  dead  {
   		capture noisily svy,subpop(if model_obs==1  & `smk_strata' ==1): cloglog `depvar' i.XSPD5, eform nolog
	}
...
foreach depvar of varlist  dead  {
		...
		i.XSPD5 i.alc_s i.phy_s , eform nolog
	}
	
foreach depvar of varlist  dead  {
   		capture noisily svy,subpop(if model_obs==1  & `smk_strata' ==1): cloglog `depvar' `demo' `ses' ///
		i.XSPD5 i.alc_s i.phy_s i.chronic1p, eform nolog
	}
	
	foreach depvar of varlist  dead  {
   		capture noisily svy,subpop(if model_obs==1  & `smk_strata' ==1): cloglog `depvar' `demo' `ses' ///
		i.XSPD5 i.alc_s i.phy_s i.chronic1p i.XSPD5##i.chronic1p, eform nolog
	}
...
log close EverSMK_Models_ages50_74
