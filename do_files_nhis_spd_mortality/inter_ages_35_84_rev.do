...
capture log close inter_ages35_84
clear
set more off
...
log using "H:\spd_mort_results\inter_ages35_84.log", name (inter_ages35_84) replace
...
foreach var of varlist chronic1p cig_s alc_s phy_s {
     display _newline(2) _column(40) "Stratified on Potential Confounders - age group = `xaa_age_grp'"
   		capture noisily svy,subpop(if xaa_age_grp== `xaa_age_grp'): cloglog dead `demo' `ses' i.xspd2##i.`var', eform nolog
   		 }
}
  

log close inter_ages35_84
