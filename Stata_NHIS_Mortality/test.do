...
capture noisily svy: cloglog dead i.sex ib2.xspd2 ib3.xsmoke i.dur_cat i.a_age_grp ///
             ib2.racehisp i.educ_cat i.bmicat i.xchronic , eform nolog
...
capture la var _Idur_cat_2 "SurvDur 7-12 Quarts (1.75-3.00 Yrs)"
capture la var _Idur_cat_3 "SurvDur 13-20 Quarters (3.25-5.00 Yrs)"
capture la var _Idur_cat_4 "SurvDur 21-39 Quarters (5.25-9.75 Yrs)"

 est store test						   
est table test, label  b(%5.2f) ///
 ...
 margins xspd2, at(xa_age_grp=1 xa_age_grp=2 xa_age_grp=3 xa_age_grp=4 xa_age_grp=5 xa_age_grp=6)
