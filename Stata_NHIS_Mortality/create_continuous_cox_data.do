...
label define  ta_age_grp_v 1 "25-44 Yrs" 2 "45-64 Yrs" 3 "65-84 Yrs" 
	 ...
	 table xa_age_grp xspd2, by(mortstat) contents(freq)
	 table ta_age_grp xspd2, by(mortstat) contents(freq)
	 table ta_age_grp xspd2, by(xsmoke mortstat) contents(freq)
	 ...
	 count if mortstat==1 & xa_age_grp==1 & sex==1 & xspd2==1 & xsmoke==1
	 
	 
	 table xa_age_grp sex xspd2, by(xsmoke) contents(freq)
	 count if mortstat==1 & xa_age_grp==1 & sex==1 & xspd2==1 & xsmoke==1
